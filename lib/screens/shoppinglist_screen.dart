      ...
      return Scaffold(
        ...
        body: FutureBuilder<Map<String, Map<String, dynamic>>>(
            future: householdProvider
                .getHouseholdMembersData(householdProvider.household.id),
                      ...
                      child: shoppingList.isNotEmpty
                          ? ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                var priceDisplay = shoppingItem['price'] == 0.0
                                    ? "          "
                                    : '${shoppingItem['price'].toStringAsFixed(2)} €';
                                return Dismissible(
                                  key: UniqueKey(),
                                  onDismissed: (direction) {
                                    setState(() {
                                      householdProvider.removeShoppingItem(
                                          shoppingItem['id']);
                                      householdProvider
                                  ...
                                  child: ListTile(
                                    ...
                                    trailing:
                                      ...
                                      Text(
                                        '${shoppingItem['points']} P.',
                                        style: const TextStyle(height: 4.5),
                                      ),
                                      Text(
                                        '${shoppingItem['amount']} x',
                                        style: const TextStyle(height: 4.5),
                                      ),
                                      Text(
                                        priceDisplay,
                                      ...
                                      buildMemberCircle(
                                          members?[shoppingItem['assignedTo']]
                                              ?['username'],
                                          40,
                                          0.2),
                                      Checkbox(
                                        ...
                                        onChanged: (value) {
                                          showDialog(
                                              ...
                                              builder: (context) => AlertDialog(
                                                    title: Text(
                                                        '${shoppingItem['name']} Status umschalten?'),
                                                    actions: [
                                                      IconButton(
                                                        onPressed: () {
                                          ...
                                          setState(() {
                                            householdProvider.loadHousehold(
                                                widget.householdId);
                                          });
                                        },
                                      )
                          ...
                          : const Center(
                              child:
                                  Text("Die Einkaufsliste ist momentan leer.")),
                    ),
                    ElevatedButton(
                        onPressed: () {
                          showDialog(
            ...
            showModalBottomSheet(
              ...
              builder: (context) => Padding(
                ...
                child: Column(
                    ...
                    children: <Widget>[
                      ShoppingListAddScreen(
                          householdId: widget.householdId, edit: false)
                    ]),
              ),
            );
          },
