                      ...
                      child: taskList.isNotEmpty
                          ? ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final dateDueDisplay = taskItem['dateDue']
                                        .toDate()
                                  ...
                                  child: ListTile(
                                    ...
                                    trailing: Wrap(
                                      ...
                                      children: <Widget>[
                                        Text(
                                            formatter.format(
                                                taskItem['dateDue'].toDate()),
                                            style: TextStyle(
                                                height: 4,
                                                fontSize: 14,
                                                color: dateDueDisplay)),
                                        Text(
                                          '${taskItem['points']} P.',
                                          style: const TextStyle(
                                              height: 4, fontSize: 14),
                                        ),
                                        buildMemberCircle(
                                            members?[taskItem["assignedTo"]]
                                                ?['username'],
                                            40,
                                            0.2),
                                        Checkbox(
                                          ...
                                          onChanged: (value) {
                                            showDialog(
                                                ...
                                                builder: (context) =>
                                                    AlertDialog(
                                                      title: Text(
                                                          '${taskItem['name']} Status umschalten?'),
                                                      actions: [
                                                        IconButton(
                                                          onPressed: () {
                                                            Navigator.of(
                          ...
                          : const Center(
                              child:
                                  Text("Die Aufgabenliste ist momentan leer.")),
                    ),
                    ElevatedButton(
                        onPressed: () {
                          showDialog(
